...
colors.groups = {
	all = {
		...
		["@lsp.typemod.method.definition.cpp"]                           = { link = "@function" },
		["@lsp.typemod.method.declaration.cpp"]                          = { link = "@function" },
		["@lsp.typemod.class.constructorOrDestructor.declaration.cpp"]   = { link = "@function" },
